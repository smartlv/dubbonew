...
public abstract class AbstractBenchmarkClient
{
    ...
    public void run(String[] args) throws Exception
    {
        ...
        StringBuilder startInfo = new StringBuilder(dateFormat.get().format(currentDate));
        ...
        startInfo.append(" s,the benchmark will end at:").append(dateFormat.get().format(calendar.getTime()));
        ...
        // 等着SimpleProcessorBenchmarkClientRunnable 会countdown
        latch.await();
